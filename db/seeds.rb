...
App.create( { :name=>"txtr", :android_id=>"com.txtr.android", 
			  ...
			  :win8_id=>"txtr-reader/1e3b5a45-302f-4e99-a4d3-9a2371c2a395", :win8_country=>"de-de" })
